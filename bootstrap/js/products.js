function renderProducts(apiResponse) {
    ...
    products.forEach(product => {
        ...
        const image = productData.productMainImage ? getValidImageUrl(productData.productMainImage) : 'https://picsum.photos/300/200?random=' + product.id;
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-4">
            <div class="product-card bg-white bg-opacity-10 rounded-4 shadow-sm h-100 position-relative" data-product-id="${id}">
                ...
                <div class="overflow-hidden">
                    <img src="${image}" class="product-image w-100 loading" alt="${name}"
                        onload="this.classList.remove('loading')"
                        onerror="this.onerror=null; this.src='https://picsum.photos/300/200?random=' + Math.random(); this.classList.remove('loading');">
                </div>
                <div class="p-4">
